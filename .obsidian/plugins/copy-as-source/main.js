...
var nr = (e, t8, r, n) => {
  if (t8 && typeof t8 == "object" || typeof t8 == "function")
    for (let o of Fu(t8))
      !du.call(e, o) && o !== r && $e(e, o, { get: () => t8[o], enumerable: !(n = fu(t8, o)) || n.enumerable });
  return e;
};
...
function Wu(e, t8) {
  var _a2, _b;
  if (t8)
    return (_b = (_a2 = e.find(({ name: r }) => r.toLowerCase() === t8)) != null ? _a2 : e.find(({ aliases: r }) => r == null ? void 0 : r.includes(t8))) != null ? _b : e.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t8}`));
}
function Uu(e, t8) {
  var _a2, _b, _c;
...
var te = { key: (e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), value(e) {
  ...
  if (Array.isArray(e))
    return `[${e.map((r) => te.value(r)).join(", ")}]`;
...
function Xu(e, { isCLI: t8, FlagSchema: r }) {
  ...
  for (let o of e)
    n.push(Zu(o, { isCLI: t8, optionInfos: e, FlagSchema: r })), o.alias && t8 && n.push(nt.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
var Vt = class {
  ...
  findAncestor(t8) {
    for (let r of ce(this, de, pt).call(this))
      if (t8(r))
        return r;
  }
  hasAncestor(t8) {
...
function Nn(e, t8) {
  let { comments: r } = e;
  if (delete e.comments, !Mt(r) || !t8.printer.canAttachComment)
    return;
  ...
  for (let [p, l] of f2.entries()) {
    ...
    let $;
    if (i ? $ = [l] : (F2.enclosingNode = E2, F2.precedingNode = m, F2.followingNode = C, $ = [F2, g, h2, B, Z]), Co(g, h2, f2, p))
      F2.placement = "ownLine", a(...$) || (C ? ne(C, F2) : m ? ue(m, F2) : E2 ? X(E2, F2) : X(B, F2));
    else if (ho(g, h2, f2, p))
      F2.placement = "endOfLine", c(...$) || (m ? ue(m, F2) : C ? ne(C, F2) : E2 ? X(E2, F2) : X(B, F2));
    else if (F2.placement = "remaining", !d(...$))
      if (m && C) {
        let Q2 = n.length;
        Q2 > 0 && n[Q2 - 1].followingNode !== C && wn(n, h2), n.push(l);
      } else
        m ? ue(m, F2) : C ? ne(C, F2) : E2 ? X(E2, F2) : X(B, F2);
  }
  if (wn(n, t8), !i)
    for (let p of r)
...
function wn(e, t8) {
  ...
  for (i = r; i > 0; --i) {
    ...
    if ((_a2 = (D = (s = t8.printer).isGap) == null ? void 0 : D.call(s, f2, t8)) != null ? _a2 : /^[\s(]*$/.test(f2))
      u = t8.locStart(a);
    else
      break;
  }
...
function Oo(e, t8, { locStart: r, locEnd: n }) {
  ...
  let i = r(e.node);
  for (let D of jn(t8.parentNodes))
    if (r(D) >= i)
      u = D;
    else
      break;
...
function So(e, t8) {
  ...
  for (let D of bn(e, { getVisitorKeys: u, filter: i }))
    s = D;
  return s;
}
var Wn = So;
  ...
  switch (Fe2(t8)) {
    ...
    case ee2:
      if (!t8.contents && !t8.id && !t8.break && !t8.expandedStates)
        return "";
      if (t8.contents.type === ee2 && t8.contents.id === t8.id && t8.contents.break === t8.break && t8.contents.expandedStates === t8.expandedStates)
        return t8.contents;
      break;
    case ue2:
    case oe2:
...
function ln2(t8, e) {
  var r;
  if (t8.type === "text" || t8.type === "comment" || Pe2(t8) || t8.type === "yaml" || t8.type === "toml")
    return null;
...
function pi(t8, e) {
  var _a2, _b;
  if (e)
    return (_b = (_a2 = t8.find(({ name: r }) => r.toLowerCase() === e)) != null ? _a2 : t8.find(({ aliases: r }) => r == null ? void 0 : r.includes(e))) != null ? _b : t8.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${e}`));
}
function hi(t8, e) {
  var _a2, _b, _c;
...
function Vi(t8, e) {
  t8.walk((r) => {
    ...
    if (n) {
      ...
      for (let s of n)
        s.isLeadingSpaceSensitive = _n2(s, e), s.isTrailingSpaceSensitive = En(s, e);
...
function kt2(t8, e) {
  if (gr2(!t8.isSelfClosing), qn2(t8, e))
    return "";
  switch (t8.type) {
    case "ieConditionalComment":
      return "<!";
...
function na(t8) {
    ...
    for (p(Ji), s = "", i = "in descriptor"; ; ) {
      if (a = t8.charAt(o), i === "in descriptor")
        ...
        if (a === ")")
          ...
          s += a;
      else if (i === "after descriptor" && !Hn2(a))
        if (a === "") {
          d();
          return;
        } else
  ...
  function d() {
    ...
    for (B = 0; B < n.length; B++)
      g = n[B], y2 = g[g.length - 1], $ = g.substring(0, g.length - 1), w2 = parseInt($, 10), q2 = parseFloat($), Vn2.test($) && y2 === "w" ? ((_2 || D) && (C = true), w2 === 0 ? C = true : _2 = w2) : ra.test($) && y2 === "x" ? ((_2 || D || P2) && (C = true), q2 < 0 ? C = true : D = q2) : Vn2.test($) && y2 === "h" ? ((P2 || D) && (C = true), w2 === 0 ? C = true : P2 = w2) : C = true;
    if (!C)
...
function Yn2(t8, e) {
  ...
  if (r.fullName === "style" && !e.parentParser && !n.includes("{{"))
    return async (s) => De2(await s(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
...
function la(t8, e) {
  ...
  if (n === "v-for")
    return jn2;
  if (n === "generic" && yt2(r.parent, e))
    return Kn2;
  let s = L2(r), i = $e2(t8, e);
  if (Bn2(r) || Ln2(r, e))
    return (a) => Qn2(s, a, { parseWithTs: i });
  ...
  if (n.startsWith("v-"))
    return (a) => Jn2(s, a, { parseWithTs: i });
}
...
async function es(t8, e) {
  let r = [];
  for (let [n, s] of t8.split(Sr2).entries())
    if (n % 2 === 0)
      r.push(T2(s));
    else
      try {
...
function da(t8, e) {
  ...
  let s = L2(r);
  if (/^i18n(?:-.+)?$/.test(n))
    return () => De2(gt(vt2(r, s.trim())), !s.includes("@@"));
  if (Sr2.test(s))
    return (i) => es(s, i);
}
var ts = da;
...
function Ca(t8) {
  return async (e, r, n, s) => {
    ...
    if (i)
      return i = Ct2(i, (a) => typeof a == "string" ? v2(false, a, '"', "&quot;") : a), [n.node.rawName, '="', E(i), '"'];
  };
}
var rs = ga;
  ...
  return t8.map((i, a) => {
    ...
    if (N2(o)) {
      if (o.prev && N2(o.prev)) {
        let _2 = Pt2(o.prev, o);
        if (_2)
          return Ye2(o.prev) ? [S2, S2, rt2(i, e, r)] : [_2, rt2(i, e, r)];
      }
      return rt2(i, e, r);
    }
...
function is(t8, e, r) {
  let { node: n } = t8;
  if (_t2(n, e))
    return [W2(n, e), E(et2(t8, e, r)), T2(Ft(n, e)), ...Qe2(n, e), U2(n, e)];
...
`);
  ...
  _endToken(e, r) {
    if (this._currentTokenStart === null)
      throw new ct2("Programming error - attempted to end a token when there was no start to the token", this._currentTokenType, this._cursor.getSpan(r));
    if (this._currentTokenType === null)
      throw new ct2("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
  ...
  handleError(e) {
    if (e instanceof ht2 && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof pt2)
  ...
  _requireCharCode(e) {
    ...
    if (!this._attemptCharCode(e))
      throw this._createError(Ue2(this._cursor.peek()), this._cursor.getSpan(r));
  }
  _attemptStr(e) {
    let r = e.length;
  ...
  _requireCharCodeUntilFn(e, r) {
    ...
    if (this._attemptCharCodeUntilFn(e), this._cursor.diff(n) < r)
      throw this._createError(Ue2(this._cursor.peek()), this._cursor.getSpan(n));
  }
  _attemptUntilChar(e) {
  ...
  _consumeTagOpen(e) {
    let r, n, s, i = [];
    try {
      if (!bt2(this._cursor.peek()))
        throw this._createError(Ue2(this._cursor.peek()), this._cursor.getSpan(e));
  ...
  _consumeAttributeName() {
    ...
    if (e === 39 || e === 34)
      throw this._createError(Ue2(e), this._cursor.getSpan());
    this._beginToken(14);
    let r = this._consumePrefixAndName();
...
var Kt2 = class t3 {
  ...
  advanceState(e) {
    if (e.offset >= this.end)
      throw this.state = e, new ht2('Unexpected character "EOF"', this);
  ...
  processEscapeSequence() {
    ...
    if (e() === 92)
      if (this.internalState = { ...this.state }, this.advanceState(this.internalState), e() === 110)
        ...
        fr2(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
  }
  decodeHexDigits(e, r) {
    let n = this.input.slice(e.internalState.offset, e.internalState.offset + r), s = parseInt(n, 16);
    if (isNaN(s))
      throw e.state = e.internalState, new ht2("Invalid hexadecimal escape sequence", e);
    return s;
  }
};
var ht2 = class {
...
var Or2 = class t6 {
  ...
  build() {
    ...
    for (let e of this._containerStack)
      e instanceof J2 && this.errors.push(I2.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
  }
  _advance() {
    let e = this._peek;
  ...
  _parseExpansionCase() {
    ...
    if (this._peek.type !== 22)
      return this.errors.push(I2.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
    ...
    for (; ; ) {
      if ((this._peek.type === 20 || this._peek.type === 22) && n.push(this._peek.type), this._peek.type === 23)
        if (Ns(n, 22)) {
          ...
          return this.errors.push(I2.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
      if (this._peek.type === 24)
        if (Ns(n, 20))
          n.pop();
        else
...
`) {
  ...
  _consumeEndTag(e) {
    ...
    if (r && this.getTagDefinition(r).isVoid)
      this.errors.push(I2.create(r, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`));
  ...
  _popContainer(e, r, n) {
    ...
    for (let i = this._containerStack.length - 1; i >= 0; i--) {
      ...
      if (Me2(a.name) ? a.name === e : (e == null || a.name.toLowerCase() === e.toLowerCase()) && a instanceof r)
  ...
  _getClosestParentElement() {
    for (let e = this._containerStack.length - 1; e > -1; e--)
      if (this._containerStack[e] instanceof z2)
...
function qs(t8, e) {
  if (t8.value)
    for (let { regex: r, parse: n } of go2) {
...
function Vs(t8, e, r) {
  ...
  let d = (c) => {
    ...
    if (c.type === "element" && (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de2(c)) && (c.name = _2(c.name, (g) => Os.has(g))), a))
      for (let g of c.attrs)
        g.namespace || (g.name = _2(g.name, (y2) => Jt2.has(c.name) && (Jt2.get("*").has(y2) || Jt2.get(c.name).has(y2))));
  }, P2 = (c) => {
